...
func isValid(point1 [2]int, point2 [2]int, grid [][]int) bool {
	return true
}
...
func getMaxArea(points [][2]int) int {
	...
	points, N, M := normalizePoints(points, 1)

	grid := markBoundaries(points, N, M)

	fmt.Println("normalised points: \n", points)

	fmt.Println("grid size: ", N, M)
